...
import * as nc_099_approval_workflow from '~/meta/migrations/v2/nc_099_approval_workflow';
...
export default class XcMigrationSourcev2 {
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'nc_099_approval_workflow':
        return nc_099_approval_workflow;
    }
  }
}
